...
class Guess:
    ...
    def expand(self, old_guess, new_guess, question, answer_for_new):
        ...
        Parameters:
            ...
            question (str): A question to separate old guess from new_guess
        ...
        Example:
            ...
            with Python, C++, Java and Ruby:
                ...
                game.expand('Python', 'Ruby', 'Does it enforce indentation', False)
        """
    ...
    def get_question(self, id=0):
        ...
        Returns:
            ...
            None otherwise. If None is returned, that means the game
    ...
    def get_guess(self, id=0):
        ...
        Returns:
            The guess for the given position in the game if available, or
    ...
    def answer_question(self, answer, id=0):
        ...
        Raises:
            GuessError: The id given does not point
            IndexError: Unknown id.
        """
        if answer:
